...
namespace Thrift.Transport
{
    public class THttpClient : TTransport
    {
        ...
        private WebResponse response_ = null;
        ...
        public override void Flush()
        {
            ...
            try
            {
                ...
                using (Stream reqStream = connection.GetRequestStream())
                {
                ...
                this.response_ = connection.GetResponse();
                this.inputStream_ = this.response_.GetResponseStream();
            }
            catch (IOException iox)
            {
                throw new TTransportException(iox.ToString());
